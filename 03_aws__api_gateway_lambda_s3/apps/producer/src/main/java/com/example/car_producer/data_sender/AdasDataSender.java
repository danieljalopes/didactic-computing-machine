...
@Slf4j
@NoArgsConstructor
public class AdasDataSender implements Runnable {
	private String vin;
	private String url;
	...
	public AdasDataSender(String vin, String url) {
		this.vin = vin;
		this.url = url;
	}
	...
	public void run() {
		while (true) {
			try {
				...
				headers.add("DataType", "ADAS");
				HttpEntity<DTO> entity = new HttpEntity<DTO>(dtoFactory.generate("ADAS", vin), headers);
